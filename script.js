class Dice {
    ...
    roll() {
        ...
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = 'url("m1.jpg")';
        }
        if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = 'url("m2.jpg")';
        }
        if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = 'url("m3.jpg")';
        }
        if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = 'url("m4.jpg")';
        }
        if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = 'url("m5.jpg")';
        }
        if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = 'url("m6.jpg")';
        }
        if (this.type == 1) {
            if (this.r.checker()) {
